...
class FriendSummaryDao @Autowired constructor(
    ...
    fun queryNearByThreeMonth(conn: SQLConnection,
        ...
        var sql:String = "select \n" +
                ...
                "from carrier_voicecall cv where cv.mobile = '$mobile' and cv.task_id='$taskId' group by cv.peer_number order by 90_dial_shi_chang desc limit 10;"
    ...
    fun queryNearBySixMonth(conn: SQLConnection,
        ...
        var sql:String = "select \n" +
                ...
                "from carrier_voicecall cv where cv.mobile = '$mobile' and cv.task_id='$taskId' group by cv.peer_number order by 180_dial_shi_chang desc limit 10;"
        return this.query(conn, sql)
    }
